...
- **Acceder a la aplicación: Abre tu navegador y visita: http://localhost:3000**

# TECNOLOGÍAS UTILIZADAS
- **Framework: Next.js (React)**.
- **Estilos: Tailwind CSS para un diseño rápido, moderno y responsivo**
- **Lenguaje: JavaScript/TypeScript.**
- **Herramientas de IA: Agentes de programación integrados en Visual Studio Code para generación de código y depuración**
